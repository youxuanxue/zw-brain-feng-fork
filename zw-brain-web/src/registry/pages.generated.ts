...
export const UNMAPPED_WEBUI_SKILLS: string[] = ["assistant.investigation_summary", "demand.list", "demand.phase.advance", "demand.register", "projection.status.query", "search.intent.parse"];
