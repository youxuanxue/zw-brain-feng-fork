...
export const UNMAPPED_WEBUI_SKILLS: string[] = ["assistant.investigation_summary", "datasource.connectivity.test", "datasource.endpoint.delete", "datasource.endpoint.list", "datasource.endpoint.upsert", "datasource.table.columns", "datasource.table.list", "demand.close", "demand.list", "demand.register", "demand.response.submit", "platform.docs.read", "platform.docs.search", "reference.dict.options", "reference.organ.options", "reference.region.options", "search.intent.parse"];
