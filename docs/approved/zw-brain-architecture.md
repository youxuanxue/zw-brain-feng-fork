...
| 人口库 / 法人库（线下建库类） | 各部门线下建库 + 数据治理中心治理（**D31 修订**：主题库 / 专题库 / 数购车业务方 PR #129 复活，待 Wave 2.x+ 立项；详见 §5.6 #11）|
...
| 通用服务 / 融合服务编排 / 代理服务 | **D31 修订**：业务方 PR #129 A 类复活 20/21（待 Wave 2.x+ 立项重新设计为服务能力面，不复刻旧 BSP / 旧门户）；106 案例提出页保持不复活 |
...
| 通用服务 / 融合服务编排 / 代理服务 | independent + 部分 app-center-web | 24 + 部分 | **D31 修订**：业务方 PR #129 A 类复活 20/21 → 待 Wave 2.x+ 立项 | ⏸ 复活待立项 |
...
| 11 | **数据资源库**（主题库/专题库/数购车）| **2026-05-27 D31 修订**：业务方 PR #129 复活 D 类 4 条；归属 Wave 2.x+ 待立项；不复刻旧 BSP 形态 | 立项会议 + 业务方 PR #129 |
| 11.a | 人口库 / 法人库（线下建库类） | 仍不复造；由各部门线下建库 + 数据治理中心治理 | 立项会议业务方 02:06:36 |
| 12 | **融合 / 通用 / 代理服务**（21 条 → A 类）| **2026-05-27 D31 修订**：业务方 PR #129 复活 20/21 条（106 案例提出页除外）；归属 Wave 2.x+ 待立项；业务方明确"整合后重新设计为服务能力面，不需要 BSP / 旧门户" | 业务方 PR #129 A 类签字 |
