...
> **样本量=0 警示（F/D60，2026-06-15 负责人裁）**：除 N0 baseline 是实测外，N1/N2/N3+ 的倍速（4×/16×/**48×**）均为**预估/目标**——**首客户上线前飞轮一圈都没真转过、样本量=0、未经任何真实验证**。这些倍数是内部规划锚点，**不作对外/对上的产品卖点或"产品心跳"叙事**（对外讲体验承诺见架构基线 §1.1，不讲推算倍速）。`velocity-history.md` 落第一行真数据前，任何加速曲线一律标"未验证"。
