...
> **范围**：`old/10示例数据/*.sql`（<!-- stat:legacy.import.schemas -->17<!-- /stat --> 个 mysqldump，<!-- stat:legacy.import.tables-total -->740<!-- /stat --> 张旧表，~445 MB）→ `zw_brain/domain/models.py`（<!-- stat:legacy.import.record-classes -->74<!-- /stat --> 个 Record 类）。
...
| `legacy.import.record-classes` | <!-- stat:legacy.import.record-classes -->74<!-- /stat --> | §范围 | `grep -cE '^class .*Record' zw_brain/domain/models.py` |
