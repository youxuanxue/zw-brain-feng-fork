...
|---|---|---|---:|---:|---|
| 审批流 | 鞍山 4 级审批流 | `6e0ccb58-4e0d-42d4-b1a7-ff5694431a89` | 2 | 0.141 | draft→preview→live |
| 申请表单 | 四川 7 字段申请表 | `9a6e025f-dc19-48b2-a425-982b72681b18` | 2 | 0.154 | draft→preview→live |
...
- 自动化 e2e 实测总耗时：**0.326s**（鞍山+四川+荆州 端到端）
- 远低于 1 周 (604800s) 硬上限。
