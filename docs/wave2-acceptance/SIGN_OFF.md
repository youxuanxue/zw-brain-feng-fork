...
|---|---|---|---:|---:|---|
| 审批流 | 鞍山 4 级审批流 | `e306416b-8187-417b-979d-68f8cc39573e` | 2 | 0.132 | draft→preview→live |
| 申请表单 | 四川 7 字段申请表 | `89bbe207-6c5c-4891-82ec-0f226ab8b95f` | 2 | 0.161 | draft→preview→live |
| 推荐规则 | 荆州 5 条推荐规则 + 5 条真实 dsp_require 历史 | (5 rules) | live | 0.002 | draft→preview→live |
...
- 自动化 e2e 实测总耗时：**0.322s**（鞍山+四川+荆州 端到端）
- 远低于 1 周 (604800s) 硬上限。
