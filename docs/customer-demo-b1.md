...
> **[2026-06-05 起 现行口径]** 原「B1.2 接入扩展中心」容器已随 **D52 解体**为后台四独立模块（查审计/外部系统/流程表单/身份治理）；下文「B1.2 接入扩展中心」措辞为历史演示脚本，对应「外部系统」治理面，详见 `docs/decisions/integration-admin-governance-axis-refactor.md`。
>
