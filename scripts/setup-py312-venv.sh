...
VENDOR_RELEASE_DIR="$VENDOR_DIR/release/v0.1"
VENDOR_TARBALL="$VENDOR_RELEASE_DIR/agent-runtime-0.1.0-py312-pyc-only.tar.gz"
VENDOR_SHA256="$VENDOR_TARBALL.sha256"
VENDOR_EXTRACT_DIRNAME="agent-runtime-0.1.0-py312-pyc-only"
