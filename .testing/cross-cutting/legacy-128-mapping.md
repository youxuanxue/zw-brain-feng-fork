...
> **2026-05-27 D31 修订**：业务方 PR #129 sign-off 触发 24 条 ❌ → ⏸（A 类 20 含合并行 8 case + D 类 4 直接行 — 行 1/2/5/6/7/22/23/24/26/63-70/71/74/79/80/98/100）。⏸ 类细分两小类：原"国家通道 P2 延后"（12 条）+ "业务方 PR #129 复活待 Wave 2.x+ 立项"（24 条）。

| 类别 | 行数 | 占比 | 备注 |
|---|---|---|---|
| ✅ 映射到新 .feature（J1/J2/B1/Cross） | 60 | 47% | 不变 |
| ❌ 不复刻（接受类） | 26 | 20% | 50 → 26（24 条业务方复活转 ⏸）|
| ⏸️ 占位延后 / 复活待立项 | 36 | 28% | 12 原国家通道 + 24 D31 复活 |
...
| 行 | 用例名 | 优先级 | 处置 | 映射 |
|---|---|---|---|---|
|1 | 代理服务资源申请暂存 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（代理服务不进 IA，§5.6 #1 #11） | — |
|2 | 代理服务资源申请-有期限 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（同上） | — |
...
|5 | 融合服务资源申请-有期限 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（融合服务不进 IA（§5.6 #12） | — |
|6 | 通用服务资源申请暂存 | 中 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（通用服务不进 IA（§5.6 #12） | — |
|7 | 通用服务资源申请-有期限 | 中 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（同上） | — |
...
|22 | 融合服务列表查看 | 中 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（§5.6 #12） | — |
|23 | 通用服务列表查看 | 中 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（同上） | — |
|24 | 服务申请 | 高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（"服务"概念合并到 resource.api 物化（§3.3 / §5.6） | wave-1 j2-resource-mount (api 物化) |
| 25 | 首页 | 高 | ✅ 同行 12 | wave-0 j1-resource-discovery |
|26 | 数购车申请 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（"数购车" 是应用中心子能力（§5.6 #11） | — |
...
| 行 | 用例名 | 优先级 | 处置 |
|---|---|---|---|
| 65 / 70 / 63 / 68 / 66 / 67 / 69 / 64 | 创建代理服务 / 通用服务 / 简易融合服务 / 服务审核 / 服务发布等 | 最高 / 高 | ⏸ D31 业务方 PR #129 A 类复活，待 Wave 2.x+ 立项（重新设计为服务能力面，不复刻旧 BSP / 旧门户） |

### 系统：申请审核（8 行 → J1 主链路变更与续期）

| 行 | 用例名 | 优先级 | 处置 | 映射 |
|---|---|---|---|---|
|71 | 代理服务申请变更 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（代理服务不进 IA） | — |
...
|74 | 通用服务申请变更 | 最高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（通用服务不进 IA） | — |
...
|79 | 待审核融合服务审核 | 高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（融合服务不进 IA） | — |
|80 | 待审核融合服务受理 | 高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（同上） | — |
...
| 97 | 任务查看 | 高 | ✅ | 同上 |
|98 | 事项/主题库查看 | 高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（"主题库" 不复造（§5.6 #11） | — |
| 99 | 已办任务详情查看 | 高 | ✅ P1 工作台已办 | wave-0 j1-resource-discovery (P1) |
|100 | 主题库信息提交 | 高 | ⏸ D31 业务方 PR #129 复活，待 Wave 2.x+ 立项（§5.6 #11） | — |
...
|---|---|---|---|
| 融合服务 / 通用服务 / 代理服务 / 应用案例 | §5.6 #11 #12 业务反馈 "几乎不用" | 21 行 (16%) | **20 条 ⏸ 复活待立项 + 1 条 ❌（106 案例提出页）** |
| 数字化运营 / 大屏 | §1.3 不做大屏 | 4 行 | 4 条 ❌ 接受（业务方 B 类）|
| 数据质量检测 / 元数据采集（除 J2 反向编目） | §3.4 集团数据治理中心外部 | 2 行 | 2 条 ❌ 接受（业务方 C 类）|
| 主题库 / 专题库 / 数购车 | §5.6 #11 | 3 行 | **3 条 ⏸ 复活待立项（业务方 D 类）** |
...
合计原 ❌ 不复刻 = 50 行 → D31 修订后 **❌ 接受 26 行 + ⏸ 复活待立项 24 行**（A 类 20 + D 类 3 直接行 + D 类 1 合并行汇总；详见业务方 [PR #129](https://github.com/feng222666888/zw-brain/pull/129)）。
