...
DISPATCH_TABLE: dict[str, Handler] = {
    ...
    "resource.mount.table.prepare": resource_mount.handler_resource_mount_table_prepare,
    "resource.mount.file.prepare": resource_mount.handler_resource_mount_file_prepare,
