...
def _get_approval(brain, request_id: str) -> dict[str, Any]:
...
def _review_request(brain, request_id: str, decision: str, role: str, confirmed: bool, skill_id: str = "approval.review_decide") -> dict[str, Any]:
