...
| `demand.response.submit` | j1 | `SupplyDemandRepository.submit_response` | supply_demand_handlers |
| `demand.close` | j1 | `SupplyDemandRepository.close_demand` | supply_demand_handlers |
